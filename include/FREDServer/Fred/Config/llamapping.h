...
private:
    ...
    void processLocation(string alfId, int32_t serialId, int32_t endpointId, uint32_t repeat = 1, uint32_t delay = 0);

    bool checkIfEntryExists(const string& alfId, int32_t serialId, int32_t endpointId);
